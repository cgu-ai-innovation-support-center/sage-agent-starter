...
| Add tools, files, RAG, or external data | [`SECURITY.md`](SECURITY.md), [`docs/customization.md`](docs/customization.md) | The minimal example intentionally has none. Define approval, data, retention, and failure behavior before adding one. |
